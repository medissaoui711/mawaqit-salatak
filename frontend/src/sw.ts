...
// Tiles rarely change, serve from cache for speed
registerRoute(
...
// If a navigation request fails (user is offline), return offline.html
const navigationRoute = new NavigationRoute(
  new NetworkOnly(), 
  {
    denylist: [
      new RegExp('/api/.*'), // Don't return offline.html for API calls
    ]
  }
);

// We implement the catch handler for the navigation route manually
// because we want to serve a specific offline.html
registerRoute(
