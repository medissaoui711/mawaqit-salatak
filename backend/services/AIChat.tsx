...
const AIChat: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      // Safely access API Key for browser environment
      ...
      // Basic system instruction to guide the persona
      const systemInstruction = `
        ...
        Guidelines:
        - Be polite and use respectful language.
        - When quoting Quran or Hadith, try to provide the reference (Surah/Ayah number or Book).
        - If asked about Fatwas or complex jurisprudence, advise the user to consult a local scholar or Imam.
        - Keep answers concise but informative.
        - Reply in the same language as the user (Arabic, English, or French).
        - You are part of the "Mawaqit Neon" app.
      `;
      ...
      setMessages(prev => [...prev, { id: Date.now(), role: 'model', text: "Sorry, I encountered an error or API Key is missing. Please try again." }]);
    } finally {
      setIsLoading(false);
    }
  };
