...
export const resources: Record<Language, TranslationStructure> = {
  ar: {
    ...
    common: {
      ...
      setCycleInfo: 'تسجيل معلومات الدورة',
      cycleStartDate: 'تاريخ بدء آخر دورة',
      cycleDuration: 'مدة الدورة (أيام)',
      days: 'أيام',
      status: 'الحالة الحالية',
      purityPeriod: 'فترة الطهر',
      menstrualPeriod: 'فترة الحيض (عذر شرعي)',
      missedFasts: 'أيام الصيام الفائتة',
      trackerDisclaimer: 'هذه أداة تقديرية. يرجى استشارة أهل العلم للأحكام الدقيقة. البيانات تحفظ على جهازك فقط.',
    },
    challenges: {
  ...
  en: {
    ...
    common: {
      ...
      setCycleInfo: 'Set Cycle Information',
      cycleStartDate: 'Last Cycle Start Date',
      cycleDuration: 'Cycle Duration (days)',
      days: 'days',
      status: 'Current Status',
      purityPeriod: 'Period of Purity',
      menstrualPeriod: 'Menstrual Period (Excused)',
      missedFasts: 'Missed Fasting Days',
      trackerDisclaimer: 'This is an estimation tool. Please consult a scholar for precise rulings. Data is saved only on your device.',
    },
    challenges: {
  ...
  fr: {
    ...
    common: {
      ...
      setCycleInfo: 'Infos sur le Cycle',
      cycleStartDate: 'Date de Début du Cycle',
      cycleDuration: 'Durée du Cycle (jours)',
      days: 'jours',
      status: 'Statut Actuel',
      purityPeriod: 'Période de Pureté',
      menstrualPeriod: 'Période Menstruelle (Excusée)',
      missedFasts: 'Jours de Jeûne Manqués',
      trackerDisclaimer: 'Ceci est un outil d\'estimation. Consultez un savant pour des règles précises. Données sauvegardées sur votre appareil.',
    },
    challenges: {
